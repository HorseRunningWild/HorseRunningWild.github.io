...
<input type="checkbox" id="paper-2" class="paper-toggle">
<label for="paper-2" class="paper-label">
...
<input type="checkbox" id="paper-3" class="paper-toggle">
<label for="paper-3" class="paper-label">
...
<input type="checkbox" id="paper-4" class="paper-toggle">
<label for="paper-4" class="paper-label">
...
<input type="checkbox" id="paper-5" class="paper-toggle">
<label for="paper-5" class="paper-label">
...
<input type="checkbox" id="paper-6" class="paper-toggle">
<label for="paper-6" class="paper-label">
...
<input type="checkbox" id="paper-7" class="paper-toggle">
<label for="paper-7" class="paper-label">
...
<input type="checkbox" id="paper-8" class="paper-toggle">
<label for="paper-8" class="paper-label">
